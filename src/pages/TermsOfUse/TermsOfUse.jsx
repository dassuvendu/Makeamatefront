    ...
    <div className="create_character_wrap px-3 md:px-0 ml-0 md:ml-4">
      ...
      <div className="py-0 lg:py-0">
        <div className="container mx-auto my-0">
          <h1 className="text-2xl font-medium pb-3">Terms of Use</h1>
          <p className="pb-4">
            The MakeAMate website located at MakeAMate.com is a copyrighted work
          ...
          <p className="pb-4">
            ...
            "Service"). This service is provided by MakeAMate (hereinafter
          ...
          <p className="pb-4">
            Cookies and Web Beacons. Like any other website, MakeAMate uses
          ...
          <h2 className="text-xl font-medium pb-3">Limitation on Liability</h2>
          <p className="pb-4">
          ...
          <p className="pb-4">Email: Support@MakeAMate.com</p>
        </div>
      </div>
