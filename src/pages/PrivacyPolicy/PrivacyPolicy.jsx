    ...
    <div className="create_character_wrap px-3 md:px-0 ml-0 md:ml-4">
      ...
      <div className="py-0 lg:py-0">
        <div className="container mx-auto my-0">
          <h1 className="text-2xl font-medium pb-3">Privacy policy</h1>
          <p className="pb-4">
          ...
          <h2 className="text-xl font-medium pb-3">Interpretation</h2>
          <p className="pb-4">
          ...
          <h2 className="text-xl font-medium pb-3">Definitions</h2>
          ...
          <div className="terms_list_item pb-4">
            <ul className="pl-5">
              ...
              <li>
                Website refers to MakeAMate, accessible from MakeAMate.com
              </li>
              <li>
          ...
          <h2 className="text-xl font-medium pb-3">Types of Data Collected</h2>
          ...
          <h3 className="text-lg text-gray-500 font-medium pb-3">Usage Data</h3>
          <p className="pb-4">
          ...
          <h2 className="text-xl font-medium pb-3">Children's Privacy</h2>
          <p className="pb-4">
          ...
          <h2 className="text-xl font-medium pb-3">Links to Other Websites</h2>
          <p className="pb-4">
          ...
          <p className="pb-4">By email: support@MakeAMate.com</p>
        </div>
      </div>
