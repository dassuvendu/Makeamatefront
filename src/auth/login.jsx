...
import { AiOutlineGoogle, AiOutlineLogin } from "../assets/icons";
          ...
          <Modal.Body>
            <div className="text-center">
              ...
              <h3 className="mb-5 text-xl font-bold text-black">
                Welcome to <span className="text-red-800">MakeAMate</span>
              </h3>
              <form
              ...
              <Link
                ...
                onClick={() => googleLogin()}
              >
                <AiOutlineGoogle className="text-3xl text-red-600" />
                Google
              </Link>
